...
//
// FeatureBox(fbname: 'Chat GPT',color: Pallet.featureColor,descriptionText: 'A smarter way to stay organized and informed!',);
// FeatureBox(fbname: 'Dall-E',color: Pallet.featureColor,descriptionText: 'Make your creativity come to life',);
// FeatureBox(fbname: 'Smart Voice Assistant',color: Pallet.featureColor,descriptionText: 'A smart assistant for smart lifestyle!',);
//
      ...
      appBar: AppBar(
        ...
        actions:  [
          Builder(
              builder: (context) {
                return InkWell(
                  child: const CircleAvatar(child: Icon(Icons.settings),),
                  onTap: (){
        ...
        child: ListView(
          ...
          children: [
            DrawerHeader(
              child: Column(
                children:  [
                  const CircleAvatar(child: Icon(Icons.account_circle,size: 50.0,),),
                  Padding(
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                const aiTextBox(msg:'Good Morning, what can I do for you?',),
                ListView.builder(
                  itemBuilder: (BuildContext context, int index) {
                    return Card(
                        elevation: 3,
                        child: ListTile(
                          title: Text(userMsg[index], style: const TextStyle(fontFamily: "Century Gothic",fontWeight: FontWeight.bold),),
                          subtitle: Text(aiMsg[index]),
                        )
                    );
                  },
                )
                /*for(int i=0;i<userMsg.length;i++)...{
                  userTextBox(msg: userMsg[i],),
                  aiTextBox(msg: aiMsg[i],),
                }.toList(),*/
              ],
            ),
          ),
